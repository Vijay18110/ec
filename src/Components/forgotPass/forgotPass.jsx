...
const ForgotPass = () => {
    ...
    const forgotPassScreen = useSelector((state) => state.uireducer.forgotPassScreen);
    ...
    const handleSendOTP = async () => {
        ...
        try {
            ...
            if (obj.Status === 0) {
                console.log("fkjsdfhsdjf")
                toast.info(obj.Message);
                dispatch(uiAction.setScreen("otp"));
                setStep(2);
            }
            if (obj.Status === 1) {
                toast.error(obj.Message);
    ...
    console.log(forgotPassScreen);
    return (
        <>
            {/* Trigger Button */}
            <div className="modal-dialog  mt-2 modal-dialog-centered w-100 register-center">
                <div className="modal-content">
                    <div className="row">
                        <div className="col-lg-6 register-mob">
                            <img
                                loading="lazy"
                                src={LoginAppBanner}
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="register">
                                <h3 className="text-center mb-0 text-success">
                                    Create an account
                                </h3>
                                ...
                                <div className="p-3">
                                    {step == 1 ? (
                                        <InputBox
                                            ...
                                            id="MobileNo"
                                            // maxLength={10}
                                            handleChange={handleChangeVerify}
